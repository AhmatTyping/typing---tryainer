...
for(const [t,base] of Object.entries(extraBase)){pools[t]={};for(const lvl of ['A1','A2','B1','B2','C1']){const vs=EXTRA_LEVEL_VARIANTS[lvl];pools[t][lvl]={subjects:[base[0],base[0],vs[0][0],vs[1][0],vs[2][0],vs[3][0]],actions:[base[1],base[1],vs[0][1],vs[1][1],vs[2][1],vs[3][1]],details:[base[2],base[2],vs[0][2],vs[1][2],vs[2][2],vs[3][2]]}}}
